ccc   gg --> rhorho subprocess amplitude
      ...
      call mesint(p,1,cost,out1a)
      call mesint(p,2,cost,out2a)
      call mesint(p,3,cost,out3a)
      call mesint(p,4,cost,out4a)
      call mesint(p,5,cost,out5a)
      call mesint(p,6,cost,out6a)
      call mesint(p,7,cost,out7a)
