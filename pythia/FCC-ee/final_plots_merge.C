...
void final_plots_merge(){
 ...
 h_dsdeta90 = (TH1F*)file10_dsdpt->Get("hdsigmadeta");
 h_dsdeta90->SetMarkerStyle(24);
 h_dsdeta90->SetMarkerColor(1);
 h_dsdeta90->SetLineColor(1);
 h_dsdeta90->SetAxisRange(0.001,45,"Y");
 h_dsdeta90->SetTitle("PYTHIA simulation of d#sigma/#eta for e^{+}e^{-}#rightarrow e^{+}e^{-}/#gamma*#gamma* #rightarrow h^{#pm}");

 TFile* file160_dsdeta = new TFile("160GeV/_root/--------------");
 h_dsdeta160 = (TH1F*)file10_dsdpt->Get("hdsigmadeta");
 ...
 TFile* file240_dsdeta = new TFile("240GeV/_root/----------------------");
 h_dsdeta240 = (TH1F*)file10_dsdpt->Get("hdsigmadeta");
 ...
 TFile* file350_dsdeta = new TFile("350GeV/_root/-------------------------------");
 h_dsdeta350 = (TH1F*)file10_dsdpt->Get("hdsigmadeta");
